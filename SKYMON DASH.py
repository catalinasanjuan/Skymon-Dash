...
def main():
    ...
    anchura_imagen = 1472
    imagen_fondo1 = pygame.transform.scale(pygame.image.load('imagenes/fondopx.jpg'), (anchura_imagen, 800))
    imagen_fondo2 = pygame.transform.scale(pygame.image.load('imagenes/fondopx.jpg'), (anchura_imagen, 800))
    pos_x1 = 0
    ...
    moltrespx = pygame.image.load('imagenes/moltrespx.png')
    moltrespx = pygame.transform.scale(moltrespx, (150,150))
    
    zapdospx = pygame.image.load('imagenes/zapdospx.png')
    zapdospx = pygame.transform.scale(zapdospx, (110,110))
    
    articunopx = pygame.image.load('imagenes/articuno.png')
    articunopx = pygame.transform.scale(articunopx, (120,120))

    lugiapx = pygame.image.load('imagenes/lugiapx.png')
    lugiapx = pygame.transform.scale(lugiapx, (370,370))
   
    megapinsirpx = pygame.image.load('imagenes/megapinsirpx.png')
...
# Agrego sonido de fondo, PD = es la cancion del Furret que camina jajajaja
    pygame.mixer.init()
    pygame.mixer.music.load('scripts/musica.mp3')
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if tecla_presionada == "w":
                    ...
                    corriendo = False
        pygame.display.flip()
    #Guardar el puntaje en el archivo y mostrar los 10 mejores
    with open('scripts/puntajes.txt', 'a') as archivo:
        archivo.write(str(score) + '\n')
    
    with open('scripts/puntajes.txt', 'r') as archivo:
